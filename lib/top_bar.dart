...
Color colorTwo=Colors.blueAccent;
Color colorThree = Colors.black;

class TopBar extends StatelessWidget {
  final Color colorOne;
  final Color colorTwo;
  final Color colorThree;
  TopBar(this.colorOne,this.colorTwo,this.colorThree);
  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: CurvePainter(colorOne,colorTwo,colorThree),
    );
  }
}
